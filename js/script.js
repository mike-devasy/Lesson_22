...
let num = 10;
console.log(num);
console.log("Я")+console.log("учу")+console.log("JS")
console.log("Я учу JS");
let myLifeStyle = "isFreelance";
...
// Типи даних JS
 ...
 console.log(typeof userEyes);
 userEyes = 20;
 console.log(userEyes);
 console.log(typeof userEyes);
 let victoryOfUkraine = true;
 console.log(victoryOfUkraine);
 console.log(typeof victoryOfUkraine);
if(victoryOfUkraine){
	console.log("777");}
	else{
		console.log("0");
